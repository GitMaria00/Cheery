...
export var wallSound = new soundFile("doorchime1.mp3"); //load sound
soundArray.push(wallSound); //add sound to list of sounds

export var paddleSound = new soundFile("doorchime1.mp3");
soundArray.push(paddleSound);

export var scoreSound = new soundFile("silence.mp3");
soundArray.push(scoreSound);

export var ambientSound = new soundFile("tomorrow_slow3.mp3");
soundArray.push(ambientSound);
ambientSound.player.loop = true; //turn on looping
ambientSound.player.volume.value = -17; //turn down volume
ambientSound.player.playbackRate = 0.05; // 🔽 slow it way down
